...
public class Ekspresi {
    ...
    public void CalculatePostfix(Stack<String> calcStack, Vector<String> tokens){
    	...
    	for (int i=0; i<tokens.size();i++){
            ...
            if (isNumArab(tokens.get(i))||isLogical(tokens.get(i))){
                ...
                if (isNumArab(calcStack.peek())){
                    float fb = Float.parseFloat(calcStack.pop());
                    float fa = Float.parseFloat(calcStack.pop());
                    int b = (int)fb;
                    int a = (int)fa;
    ...
    public void Execute(){
        ...
        } else if (isNumArab(tokens.get(0))||isLogical(tokens.get(0))){ //Postfix
        ...
        if (isLogika){
            ...
            value=Integer.parseInt(calcStack.pop());
        }
    }
